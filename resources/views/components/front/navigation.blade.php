            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="{{ route('page-detail',['slug'=>'About']) }}">About</a></li>
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="{{ route('page-detail',['slug'=>'Contact']) }}">Contact</a></li>
                        ...
                        @if (isset(Auth::user()->id))
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link px-lg-3 py-3 py-lg-4" href="#" onclick="event.preventDefault();document.getElementById('form-logout').submit()">
                                    Logout</a>
                            </li>
                        @else
